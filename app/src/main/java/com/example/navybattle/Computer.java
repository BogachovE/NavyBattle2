...
public abstract class Computer {
	...
	public int getMove(int hit)	{
		...
		if (vessel.size() > 1)	{
			...
			if (shape == 1 )		{
				...
				{
				if (checkAvailability(1,low-10))		{
					gBoard[low-10]=1;
					return low-10;
				}
				else if (checkAvailability(3,high+10))	{
					gBoard[high+10]=1;
					return high+10;
				}
				else if (checkAvailability(1,low-20)){
					gBoard[low-20]=1;
					return low-20;
				}
				else if (checkAvailability(3,high+20)){
					gBoard[high+20]=1;
					return high+20;
				}
				else if (checkAvailability(1,low-30)){
					gBoard[low-20]=1;
					return low-20;
				}
				else if (checkAvailability(3,high+30)){
					gBoard[high+20]=1;
					return high+20;
				}
	...
	public boolean checkAvailability (int side, int index)	{
